...
main.obj: ../main.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"C:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include" --include_path="C:/TM4C123G_LaunchPad_Workshop/lab12/project" --include_path="C:/ti/TivaWare_C_Series-2.1.4.178" -g --define=DEBUG --define=TARGET_IS_BLIZZARD_RA2 --define=PART_TM4C123GH6PM --define=TARGET_IS_BLIZZARD_RB1 --display_error_number --diag_wrap=off --diag_warning=225 --preproc_with_compile --preproc_dependency="main.d_raw" $(GEN_OPTS__FLAG) "$<"
